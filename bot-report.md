...
|-|:-|:-:|:-:|
| [[M&#x2011;01](#01)] | Centralization risk for privileged functions | 5| 0|
| |Issue|Instances| Gas Savings
|-|:-|:-:|:-:|
| [[L&#x2011;01](#01)] | Use `increaseAllowance()`/`decreaseAllowance()` instead of `approve()`/`safeApprove()` | 1| 0|
| [[L&#x2011;02](#02)] | Use of `tx.origin` is unsafe in almost every context | 2| 0|
| [[L&#x2011;03](#03)] | Variables shadowing other definitions | 4| 0|
| [[L&#x2011;04](#04)] | Missing zero address check in constructor | 3| 0|
| [[L&#x2011;05](#05)] | Solidity version 0.8.20 or above may not work on other chains due to PUSH0 | 2| 0|
| [[L&#x2011;06](#06)] | Using `>`/`>=` without specifying an upper bound in version pragma is unsafe | 2| 0|
| [[L&#x2011;07](#07)] | Tokens may be minted to the zero address | 1| 0|
| [[L&#x2011;08](#08)] | Consider implementing two-step procedure for updating protocol addresses | 2| 0|
| [[L&#x2011;09](#09)] | Vulnerable versions of packages are being used | 1| 0|
| [[L&#x2011;10](#10)] | Missing checks for `address(0)` when setting address state variables | 3| 0|
| [[L&#x2011;11](#11)] | Owner can renounce Ownership | 3| 0|
| [[L&#x2011;12](#12)] | Constructor / initialization function lacks parameter validation | 1| 0|
| [[L&#x2011;13](#13)] | Contracts are vulnerable to fee-on-transfer accounting-related issues | 13| 0|
| [[L&#x2011;14](#14)] | Functions calling contracts/addresses with transfer hooks should be protected by reentrancy guard | 13| 0|
| [[L&#x2011;15](#15)] | Critical functions should be controlled by time locks | 2| 0|
| [[L&#x2011;16](#16)] | The safeApprove() function is deprecated | 1| 0|
| [[L&#x2011;17](#17)] | Some tokens may revert when zero value transfers are made | 9| 0|
| [[L&#x2011;18](#18)] | Loss of precision in divisions | 1| 0|
| [[L&#x2011;19](#19)] | Code does not follow the best practice of check-effects-interaction | 10| 0|
| [[L&#x2011;20](#20)] | Some tokens may revert when large transfers are made | 13| 0|
| [[L&#x2011;21](#21)] | Contracts are vulnerable to rebasing accounting-related issues | 9| 0|
| |Issue|Instances| Gas Savings
|-|:-|:-:|:-:|
| [[G&#x2011;01](#01)] | Using `private` for constants saves gas | 3| 10218|
| [[G&#x2011;02](#02)] | Constructors can be marked as payable to save deployment gas | 4| 84|
| [[G&#x2011;03](#03)] | Using `++X`/`--X` instead of `X++`/`X--` can save gas | 1| 5|
| [[G&#x2011;04](#04)] | Use custom errors rather than `revert()`/`require()` strings to save gas | 12| 600|
| [[G&#x2011;05](#05)] | Do not cache state variables that are used only once | 4| 12|
| [[G&#x2011;06](#06)] | Inline `modifier`s that are only used once to save gas | 1| 0|
| [[G&#x2011;07](#07)] | Functions that revert when called by normal users can be marked `payable` | 6| 126|
| [[G&#x2011;08](#08)] | Use `x = x + y` instead of `x += y` for state variables | 1| 10|
| [[G&#x2011;09](#09)] | Operator `>=`/`<=` costs less gas than operator `>`/`<` | 6| 18|
| [[G&#x2011;10](#10)] | Unused non-constant state variables waste gas | 1| 0|
| [[G&#x2011;11](#11)] | Usage of `int`s/`uint`s smaller than 32 bytes incurs overhead | 1| 55|
| [[G&#x2011;12](#12)] | Divisions can be unchecked to save gas | 8| 160|
| [[G&#x2011;13](#13)] | Increments can be `unchecked` to save gas | 1| 60|
| [[G&#x2011;14](#14)] | Use assembly to validate `msg.sender` | 3| 36|
| [[G&#x2011;15](#15)] | Using assembly to check for zero can save gas | 5| 30|
| [[G&#x2011;16](#16)] | Avoid contract existence checks by using low level calls | 8| 800|
| [[G&#x2011;17](#17)] | Use `uint256(1)`/`uint256(2)` instead of `true`/`false` to save gas for changes | 4| 68400|
| [[G&#x2011;18](#18)] | Avoid zero transfer to save gas | 9| 900|
| [[G&#x2011;19](#19)] | Optimize names to save gas | 4| 88|
| [[G&#x2011;20](#20)] | Reduce gas usage by moving to Solidity 0.8.19 or later | 2| 0|
| [[G&#x2011;21](#21)] | Newer versions of solidity are more gas efficient | 4| 0|
| [[G&#x2011;22](#22)] | Avoid updating storage when the value hasn't changed | 5| 4000|
| [[G&#x2011;23](#23)] | State variables that are used multiple times in a function should be cached in stack variables | 4| 1164|
| [[G&#x2011;24](#24)] | Contracts can use fewer storage slots by truncating state variables | 1| 20000|
| [[G&#x2011;25](#25)] | Refactor duplicated `require()`/`revert()` checks to save gas | 1| 0|
| [[G&#x2011;26](#26)] | Use assembly to emit events | 9| 342|
| [[G&#x2011;27](#27)] | Use `calldata` instead of `memory` for immutable arguments | 2| 1200|
| [[G&#x2011;28](#28)] | Using `bool`s for storage incurs overhead | 4| 400|
| [[G&#x2011;29](#29)] | Multiple accesses of the same mapping/array key/index should be cached | 13| 924|
| [[G&#x2011;30](#30)] | Multiple mappings can be replaced with a single struct mapping | 4| 168|
| |Issue|Instances| Gas Savings
|-|:-|:-:|:-:|
...
| |Issue|Instances| Gas Savings
|-|:-|:-:|:-:|
| [[D&#x2011;01](#01)] | Using `private` rather than `public` for constants, saves gas | 4| 0|
| [[D&#x2011;02](#02)] | Event names should use CamelCase | 12| 0|
| [[D&#x2011;03](#03)] | Avoid double casting | 1| 0|
| [[D&#x2011;04](#04)] | Event is missing `indexed` fields | 1| 0|
| [[D&#x2011;05](#05)] | `internal` functions only called once can be inlined to save gas | 1| 30|
| [[D&#x2011;06](#06)] | Variables should be named in mixedCase style | 1| 0|
| [[D&#x2011;07](#07)] | safeMint should be used in place of mint | 3| 0|
| [[D&#x2011;08](#08)] | `x += y` is more expensive than `x = x + y` for state variables | 12| 0|
| [[D&#x2011;09](#09)] | Revert on transfer to the zero address | 13| 0|
| [[D&#x2011;10](#10)] | `SafeTransferLib` does not ensure that the token contract exists | 14| 0|
| [[D&#x2011;11](#11)] | Solidity version 0.8.20 or above may not work on other chains due to PUSH0 | 2| 0|
| [[D&#x2011;12](#12)] | SPDX identifier should be the in the first line of a solidity file | 4| 0|
| [[D&#x2011;13](#13)] | Numbers downcast to `address`es may result in collisions | 8| 0|
| [[D&#x2011;14](#14)] | Unused named return | 1| 0|
| [[D&#x2011;15](#15)] | Unused named return variables without optimizer waste gas | 1| 9|
| [[D&#x2011;16](#16)] | Using bitmap to store bool states can save gas | 3| 0|
| [[D&#x2011;17](#17)] | Using `delete` statement can save gas | 2| 16|
| [[D&#x2011;18](#18)] | Use `!= 0` or `== 0` for unsigned integer comparison | 4| 0|
| [[D&#x2011;19](#19)] | Avoid contract existence checks by using low level calls | 6| 0|
| [[D&#x2011;20](#20)] | Use Ownable2Step instead of Ownable | 3| 0|
| [[D&#x2011;21](#21)] | Events that mark critical parameter changes should contain both the old and the new value | 1| 0|
| [[D&#x2011;22](#22)] | `safeTransfer` function does not check for contract existence | 4| 0|
| [[D&#x2011;23](#23)] | Assembly block creates dirty bits | 1| 0|
| [[D&#x2011;24](#24)] | `require()` or `revert()` statements that check input arguments should be at the top of the function | 4| 0|
| [[D&#x2011;25](#25)] | Division by zero not prevented | 1| 0|
| [[D&#x2011;26](#26)] | Inconsistent spacing in comments | 4| 0|
| [[D&#x2011;27](#27)] | Consider activating via-ir for deploying | 1| 0|
| [[D&#x2011;28](#28)] | Enable IR-based code generation | 1| 0|
| [[D&#x2011;29](#29)] | Large approvals may not work with some `ERC20` tokens | 1| 0|
| [[D&#x2011;30](#30)] | Contracts are vulnerable to rebasing accounting-related issues | 1| 0|
...
### [L&#x2011;05] Solidity version 0.8.20 or above may not work on other chains due to PUSH0
...
### [L&#x2011;16] The safeApprove() function is deprecated
...
### [L&#x2011;18] Loss of precision in divisions
...
*GitHub* : [50](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asD.sol#L50),[66](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asD.sol#L66),[88](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asD.sol#L88)
### [L&#x2011;21] Contracts are vulnerable to rebasing accounting-related issues
...
### [G&#x2011;05] Do not cache state variables that are used only once
...
### [G&#x2011;10] Unused non-constant state variables waste gas
...
### [G&#x2011;12] Divisions can be unchecked to save gas
...
### [G&#x2011;15] Using assembly to check for zero can save gas
...
### [G&#x2011;18] Avoid zero transfer to save gas
...
*GitHub* : [2](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L2)
### [G&#x2011;21] Newer versions of solidity are more gas efficient
...
### [G&#x2011;24] Contracts can use fewer storage slots by truncating state variables
...
*GitHub* : [15](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L15)
### [G&#x2011;29] Multiple accesses of the same mapping/array key/index should be cached
...
### [G&#x2011;30] Multiple mappings can be replaced with a single struct mapping
...
### [N&#x2011;01] NatSpec documentation for contract is missing
...
### [N&#x2011;03] Order of functions does not follow the Solidity Style Guide
...
### [N&#x2011;06] Large numeric literals should use underscores for readability
...
### [N&#x2011;08] Simplify complex require statements
...
### [N&#x2011;13] Events should be emitted before external calls
...
*GitHub* : [89](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asD.sol#L89)
### [N&#x2011;14] Events are emitted without the sender information
...
### [N&#x2011;16] Imports could be organized more systematically
...
### [N&#x2011;17] @openzeppelin/contracts should be upgraded to a newer version
...
### [N&#x2011;19] Magic numbers should be replaced with constants
...
### [N&#x2011;20] Memory-safe annotation preferred over comment variant
...
*GitHub* : [20](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L20)
### [N&#x2011;26] Event declarations should have NatSpec descriptions
...
*GitHub* : [33](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L33)
### [N&#x2011;30] State variables should have NatSpec descriptions
...
*GitHub* : [12](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L12)
### [N&#x2011;31] Contract name does not follow the Solidity Style Guide
...
*GitHub* : [8](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L8)
### [N&#x2011;32] Functions should be named in mixedCase style
...
*GitHub* : [12](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L12)
### [N&#x2011;34] Missing zero address check in functions with address parameters
...
### [N&#x2011;35] Constants should be put on the left side of comparisons
...
### [N&#x2011;37] Non-interface files should use fixed compiler versions
...
*GitHub* : [2](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L2)
### [N&#x2011;38] Unused contract variables
...
### [N&#x2011;41] Use the latest Solidity version
...
*GitHub* : [2](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L2)
### [N&#x2011;42] Named mappings are recommended
...
*GitHub* : [15](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L15)
### [N&#x2011;43] Whitespace in Expressions
...
### [N&#x2011;44] Modifier declarations should have NatSpec descriptions
...
*GitHub* : [33](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L33)
### [N&#x2011;46] Addresses shouldn't be hard-coded
...
### [N&#x2011;48] Control structures do not follow the Solidity Style Guide
...
### [N&#x2011;49] Do not cache immutable variables
...
### [N&#x2011;50] Missing event for critical changes
...
*GitHub* : [64](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asD.sol#L64)
### [N&#x2011;52] Consider adding emergency-stop functionality
...
*GitHub* : [8](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L8)
### [N&#x2011;53] Avoid the use of sensitive terms
...
*GitHub* : [80](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/1155tech-contracts/src/Market.sol#L80)
### [N&#x2011;61] Contracts should have full test coverage
...
*GitHub* : [0](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1)
### [N&#x2011;62] Large or complicated code bases should implement invariant tests
...
### [N&#x2011;65] Error messages should be descriptive, not cryptic
...
*GitHub* : [42](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/1155tech-contracts/src/bonding_curve/LinearBondingCurve.sol#L42)
### [D&#x2011;06] Variables should be named in mixedCase style
...
*GitHub* : [15](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L15)
### [D&#x2011;07] safeMint should be used in place of mint
...
### [D&#x2011;09] Revert on transfer to the zero address
The rule is valid, but the following findings are invalid.
...
### [D&#x2011;11] Solidity version 0.8.20 or above may not work on other chains due to PUSH0
...
*GitHub* : [42](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/1155tech-contracts/src/bonding_curve/LinearBondingCurve.sol#L42)
### [D&#x2011;16] Using bitmap to store bool states can save gas
...
### [D&#x2011;19] Avoid contract existence checks by using low level calls
Prior to 0.8.10 the compiler inserted extra code, including EXTCODESIZE (100 gas), to check for contract existence for external function calls. In more recent solidity versions, the compiler will not insert these checks if the external call has a return value. Similar behavior can be achieved in earlier versions by using low-level calls, since low level calls never check for contract existence.
...
*GitHub* : [29](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L29)
### [D&#x2011;20] Use Ownable2Step instead of Ownable
...
*GitHub* : [8](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L8)
### [D&#x2011;21] Events that mark critical parameter changes should contain both the old and the new value
...
*GitHub* : [24](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asDFactory.sol#L24)
### [D&#x2011;23] Assembly block creates dirty bits
...
### [D&#x2011;25] Division by zero not prevented
...
### [D&#x2011;26] Inconsistent spacing in comments
...
### [D&#x2011;27] Consider activating via-ir for deploying
The rule is invalid for this project
...
*GitHub* : [0](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1)
### [D&#x2011;28] Enable IR-based code generation
The rule is invalid for this project
...
*GitHub* : [51](https://github.com/code-423n4/2023-11-canto/blob/516099801101950ac9e1117a70e095b06f9bf6a1/asD/src/asD.sol#L51)
### [D&#x2011;30] Contracts are vulnerable to rebasing accounting-related issues
The rule is invalid for this project
